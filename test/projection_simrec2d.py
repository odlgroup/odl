...
class Projection(OP.LinearOperator):
    ...
    def applyImpl(self,data, out):
        forward = SR.SRPyForwardProject.SimpleForwardProjector(data.values,self.volumeOrigin,self.voxelSize,self.detectorSize,self.stepSize)
...
class ProjectorMultiple(OP.LinearOperator):
