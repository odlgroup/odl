...
space = odl.uniform_discr([-1, -1], [1, 1], (512, 512), dtype='complex', impl='pytorch')
...
phantom_ft.show(title='Full Fourier Transform', force_show=False)
...
print(f"{padded_ft_op.range.element().dtype=}")
