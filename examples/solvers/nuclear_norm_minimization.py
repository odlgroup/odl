...
l2err = odl.functional.L2NormSquared(pspace).translated(data)
nuc_norm = 0.02 * odl.functional.NuclearNorm(pgradient.range)
...
f = odl.functional.ZeroFunctional(pspace)
