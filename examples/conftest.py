...
if not all([PYFFTW_AVAILABLE, PYWT_AVAILABLE,
            ASTRA_AVAILABLE, ASTRA_CUDA_AVAILABLE, SKIMAGE_AVAILABLE]):
    print('to be able to test the examples, you need to install all backends, '
          'currently: '
...
collect_ignore = [os.path.join(this_dir, 'tomo', 'stir_project.py'),
                  os.path.join(this_dir, 'tomo', 'stir_reconstruct.py')]
