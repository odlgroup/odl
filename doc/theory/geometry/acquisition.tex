...
\begin{example}[Fan beam geometry, curved detector]
...
\begin{example}[Fan beam geometry, flat detector]
...
\begin{example}[Cone beam geometry, circular acquisition, curved detector]
