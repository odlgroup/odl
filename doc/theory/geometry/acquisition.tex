...
\end{equation}
%
and is assumed to have curvature $1/R_1$ along $\theta'(\phi)$ and $1/R_2$ along $e_z$ with $R1,R_2 >0$. From the 2D case, we know that 
...
\begin{align}
 ...
 &= -(R_2 - r) \theta(\phi) + (R_2-R_1) \big[ \cos\vartheta\, \theta(\phi) + \sin\vartheta\, e_z \big] + \notag \\
...
\end{align}
%
\NOTE{Check if this makes sense!}%
