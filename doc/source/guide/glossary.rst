...
.. glossary::
    ...
    array-like
        ...
        `numpy.array` constructor. Includes all `BaseTensor` based classes.
    ...
    discretization
        ...
        It encompasses an abstract `Set`, a finite data container (`BaseGeneralizedTensor` in general) and the mappings between them,         :term:`sampling` and :term:`interpolation`.
