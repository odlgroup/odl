...
Introduction
------------
Great that you want to help making ODL better! There are basically two ways how you can contribute:
as a user or as a developer.

The best way to make contributions as a user is to play around with the software, try to use it for
your purposes and get back to us if you encounter problems or miss features. When this happens,
take a look at our `issue tracker <https://github.com/odlgroup/odl/issues>`_, and if there is no
